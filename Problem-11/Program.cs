...
namespace Problem_11
{
    class Program
    {
       public static string input = @"08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48";
        public static void Main()
        {
            ...
            for (int i = 0; i < array.GetLength(0); i++)
            {
                ...
                {
                    int temp = array[i, j] * array[i, j + 1] * array[i, j + 2] * array[i, j + 3];
                    if (temp > sum)
                    {
                        sum = temp;
                    }
        ...
        public static int[,] StringToArray(string input)
        {
            ...
            int[,] OutputArray = new int[rowCount, columnCount];
